...
function buildDefaultRange() {
  ...
  for (const r1 of RANKS) {
    for (const r2 of RANKS) {
      ...
      const hand = ri < rj ? `${r1}${r2}s` : ri > rj ? `${r2}${r1}o` : `${r1}${r2}`;
...
const SAMPLE_SPOTS = [
  ...
  },
  {
    ...
    range: buildDefaultRange(),
    description: "CO facing BTN 3bet on wet JT9 board. High connectivity favors BTN."
  },
  {
    id: "sb-bb-flop-227",
    heroPosition: "SB",
    ...
    range: buildDefaultRange(),
    description: "SB vs BB limped pot, dry paired board. Mixed strategy required."
  },
  {
    id: "btn-open-preflop",
    heroPosition: "BTN",
    ...
    action: "BTN open RFI",
    range: buildDefaultRange(),
    description: "BTN opening range, 100bb deep. Wide value + playability range."
  },
  {
  ...
  },
  {
    ...
    range: buildDefaultRange(),
    description: "River value/bluff balance on A8633T. Polarised betting strategy."
  },
  {
    id: "utg-open-preflop",
    heroPosition: "UTG",
    ...
    action: "UTG open RFI",
    range: buildDefaultRange(),
    description: "UTG tight opening range. Premium hands only with high frequency."
  },
  {
    id: "co-open-preflop",
    heroPosition: "CO",
    ...
    action: "CO open RFI",
    range: buildDefaultRange(),
    description: "CO opening range vs BTN. Wider than UTG, balanced with blockers."
  },
  {
    id: "btn-3bet-vs-co",
    heroPosition: "BTN",
  ...
  },
  {
    ...
    range: buildDefaultRange(),
    description: "Very wet connected board 876. Many draws, GTO check at high frequency."
  },
  {
    ...
    range: buildDefaultRange(),
    description: "BB facing turn bet on A43Q. Check-raise or call with strong holdings."
  },
  {
    ...
    range: buildDefaultRange(),
    description: "BB facing river overbet in 3bet pot. Bluff-catch decision with Kx."
  },
  {
    id: "flop-aa2-rainbow",
    heroPosition: "CO",
    ...
    range: buildDefaultRange(),
    description: "AA2r triple-paired board. Rare texture — most hands miss, slow play aces."
  }
];
const HERO_HANDS = [
  [
...
const GTO_EXPLANATIONS = {
  ...
  raise: "Рейз максимизирует EV с данной рукой. Выгодное соотношение ставки к банку.",
