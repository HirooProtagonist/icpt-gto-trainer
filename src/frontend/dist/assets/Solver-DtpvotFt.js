import { c as createLucideIcon, j as jsxRuntimeExports, r as reactExports, o, g as reactDomExports, u as useTranslation, e as ChevronRight } from "./index-Cbhxa_lC.js";
import { C as CardDisplay, D as DeckPicker } from "./CardDisplay-gvQWxUMu.js";
import { R as RangeMatrix } from "./RangeMatrix-CMucO62K.js";
import { c as createSlot, u as useComposedRefs, B as Button, a as Badge } from "./button-4hsIGPrH.js";
import { R as Root$2, C as Content$1, a as Close, T as Title, P as Portal$1, O as Overlay, c as createContextScope, b as createSlot$1, d as Primitive$1, u as useSize, e as useCallbackRef, f as useLayoutEffect2, g as useControllableState, h as useId, i as composeEventHandlers, j as Portal$2, k as usePrevious, l as hideOthers, m as useFocusGuards, n as ReactRemoveScroll, F as FocusScope, D as DismissableLayer } from "./index-BSi4j1Jp.js";
import { c as cn, S as SAMPLE_SPOTS } from "./sampleData-HgH5VJ6N.js";
...
function getBoardSlotCount(street) {
...
function Solver() {
  ...
  const [heroPos, setHeroPos] = reactExports.useState("BTN");
  const [villainPos, setVillainPos] = reactExports.useState("BB");
  const [stackSize, setStackSize] = reactExports.useState("100");
  const [prevAction, setPrevAction] = reactExports.useState("Open");
  const [street, setStreet] = reactExports.useState("flop");
  const [potSize, setPotSize] = reactExports.useState("10");
  const [board, setBoard] = reactExports.useState(
    Array(5).fill(null)
  );
  const [pickerSlot, setPickerSlot] = reactExports.useState(null);
  const [result, setResult] = reactExports.useState(null);
  const [resultSpot, setResultSpot] = reactExports.useState(
    null
  );
  ...
  function handleClearSlot(idx) {
    const newBoard = [...board];
    newBoard[idx] = null;
    setBoard(newBoard);
  }
  function handleSolve() {
    const matched = SAMPLE_SPOTS.find(
      (s) => s.heroPosition === heroPos && s.street === street
    ) ?? SAMPLE_SPOTS.find((s) => s.street === street) ?? SAMPLE_SPOTS[0];
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 max-w-5xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-lg bg-accent/20 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Calculator, { className: "w-5 h-5 text-accent" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-display font-bold text-foreground", children: t("solverTitle") })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm ml-12", children: t("solverSubtitle") })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border border-border rounded-xl p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-muted-foreground text-xs uppercase tracking-wide", children: t("heroPosition") }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Select,
            {
              value: heroPos,
              onValueChange: (v) => setHeroPos(v),
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  SelectTrigger,
                  {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-muted-foreground text-xs uppercase tracking-wide", children: t("villainPosition") }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Select,
            {
              value: villainPos,
              onValueChange: (v) => setVillainPos(v),
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  SelectTrigger,
                  {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-muted-foreground text-xs uppercase tracking-wide", children: t("stackSize") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-muted-foreground text-xs uppercase tracking-wide", children: t("prevAction") }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: prevAction, onValueChange: setPrevAction, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              SelectTrigger,
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: PREV_ACTIONS.map((a) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: a, children: a }, a)) })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-muted-foreground text-xs uppercase tracking-wide", children: t("street") }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Select,
            {
              value: street,
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: STREETS.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: s.value, children: s.label }, s.value)) })
              ]
            }
          )
        ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-muted-foreground text-xs uppercase tracking-wide", children: t("board") }),
          street === "preflop" ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm italic py-2", children: "No board cards on Preflop" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 flex-wrap", children: Array.from({ length: slotCount }).map((_, idx) => (
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative group", children: [
              ...
              board[idx] && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-muted-foreground text-xs uppercase tracking-wide", children: t("potSize") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: result && resultSpot && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "w-4 h-4 text-accent" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground mb-3", children: [
              ...
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent font-semibold", children: result.recommendation })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: result.actions.map((action) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground w-24 shrink-0", children: action.label }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 bg-muted rounded-full h-3 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.div,
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-mono text-foreground w-10 text-right shrink-0", children: [
                action.pct,
                "%"
              ] })
            ] }, action.label)) })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground uppercase tracking-wide mb-3", children: t("rangeViz") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              RangeMatrix,
              {
                ranges: resultSpot.range.map((cell) => ({
                  bet: cell.betFreq,
                  call: cell.callFreq,
                  fold: cell.foldFreq,
                  check: 0,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 pt-2 border-t border-border", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-emerald-500/10 border border-emerald-500/30 rounded-lg px-4 py-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "EV" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-lg font-bold text-emerald-400", children: [
                "+",
                resultSpot.potBb.toFixed(1),
                "bb"
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: t("positionsLabel") }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-semibold text-foreground", children: [
                resultSpot.heroPosition,
                " vs ",
                resultSpot.villainPosition
              ] })
            ] })
          ] })
        ]
      ...
      Dialog,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          DialogContent,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "text-foreground", children: t("selectCard") }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto py-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(DeckPicker, { onSelect: handleSelectCard, usedCards }) })
            ]
          }
        )
      }
